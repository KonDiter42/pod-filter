# wallow's Loot Filter for Path of Diablo - Preset #3
## Overview
...
White Items
-	Leaf Bases
	-	+3 Fire Bolt, Fire Ball, Immolate, or Enflame

-	Spirit Bases
	-	Crystal Sword, Broad Sword, Long Sword
	-	Monarch
	-	Paladin Shields - Sacred Targe, Sacred Rondache, Crown Shield (35%+ All Resistances)
	-	Paladin Shields - Others (40%+ All Resistances)
-	Holy Thunder Bases
	-	War Scepter
-	Insight Bases
	-	Normal Polearm/Spears: Voulge, Scythe, Poleaxe, Brandistock, War Scythe
	-	Exceptional Polearm/Spears: Bill, Battle Scythe, Partizan, Bec-De-Corbin, Grim Scythe, War Fork, Yari, Fuscina, Lance
	-	Elite Polearm/Spears: Thresher, Giant Thresher, Mancatcher, Colossus Voulge, Stygian Pike, Cryptic Axe, War Pike, Ghost Spear
	-	Elite Staves: Elder Staff, Shillelagh, Archon Staff
-	White Bases
	-	+3 Teeth, Bone Spear, Desecrate, or Poison Nova
-	Memory Bases
	-	+3 Energy Shield or Lightning Surge
-	Harmony and Faith Bases
	-	Amazon Bows: +3 Bow Skills Matriarchal Bow or Grand Matron Bow
	-	Elite Bows: Blade Bow, Shadow Bow, Great Bow, Diamond Bow, Ward Bow
-	2 Socket Armor Bases Bases
